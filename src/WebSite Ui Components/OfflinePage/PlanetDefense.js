...
import "!style-loader!css-loader!./PlanetDefense.css";
import { PUBLIC_ASSETS_PATH } from "../../Utils/Constants";

function PlanetDefense() {
  useEffect(() => {
    var sprite = new Image();
    var spriteExplosion = new Image();
    sprite.src = `${PUBLIC_ASSETS_PATH}/sprite.png`;
    spriteExplosion.src = `${PUBLIC_ASSETS_PATH}/explosion.png`;
  ...
  return (
    <div className="planetMain">
      <canvas
        id="canvas"
        style={{ backgroundImage: `url("${PUBLIC_ASSETS_PATH}/space.jpg")` }}
      ></canvas>
    </div>
  );
}

export default PlanetDefense;
