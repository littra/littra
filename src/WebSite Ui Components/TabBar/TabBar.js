      ...
      <menu className="menu">
        {renderLink(
          ...
          >
            <div className="iconNew">
              <Icon image={`${PUBLIC_ASSETS_PATH}/menu.png`} size={30} />
            </div>
          </button>,
          "#"
        )}
        ...
        {renderLink(
          <button className="menu__item" style={{ "--bgColorItem": "#e0b115" }}>
            <div className="iconNew">
              <Icon image={`${PUBLIC_ASSETS_PATH}/excellence.png`} size={40} />
            </div>
          </button>,
          "#pages"
        )}
        ...
        {renderLink(
          <button className="menu__item" style={{ "--bgColorItem": "#65ddb7" }}>
            <div className="iconNew">
              <Icon image={`${PUBLIC_ASSETS_PATH}/footer.png`} size={35} />
            </div>
          </button>,
          "#newFooter"
        )}
