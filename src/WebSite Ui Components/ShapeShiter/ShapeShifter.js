...
import "!style-loader!css-loader!./ShapeShifter.css";
  ...
  useEffect(() => {
    ...
    var S = {
      init: function() {
        ...
        if (i !== -1) {
          ...
          S.UI.simulate("Welcome|To|Littra|Technology|Type Here|#countdown 3|");
        }
    ...
    S.UI = (function() {
      var input = document.querySelector(".ui-input"),
        ...
        reload = document.querySelector(".refresh"),
        interval,
      ...
      function bindEvents() {
        ...
        reload.addEventListener("click", function(e) {
          S.UI.simulate("Welcome|To|Littra|Technology|");
        });
      ...
      <div className="iconsDiv">
        ...
        <div className="refresh">
          <div className="iconWrap">
            <Icon image={`${PUBLIC_ASSETS_PATH}/${"refresh.png"}`} size={20} />
          </div>
        </div>
      </div>
