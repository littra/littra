...
function AnimatedTabBar() {
  ...
  const dropDown = () => {
    const togglerr = document.getElementById("togg");
  ...
  return (
    <div className="Header__base___1a41w">
      <div className="Header__title___11Px4">LITTRA</div>

      <div className="Header__combinerr">
        <div className="togglerr" id="togg" onClick={dropDown}>
          <Icon image={`${PUBLIC_ASSETS_PATH}/square.svg`} size={30} />
        </div>
        <menu className="menu" id="men">
          <button
